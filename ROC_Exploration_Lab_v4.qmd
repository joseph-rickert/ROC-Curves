...
* Supports Normal, Beta, Student’s t, and Cauchy for both signal and noise, with sensible defaults.
* Provides a function per distribution and a factory to pick by name.
* Plots overlaid densities and histograms for selected signal/noise, with a vertical default threshold.
* Allows independent choice of signal and noise distributions.
* Outputs classes and probabilities in a data frame ready for pROC (Class and .pred_1).
